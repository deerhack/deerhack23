  ...
  return (
    <div className="lg:basis-[49%] w-full">
      <h2>
        <button
          type="button"
          className={clsx("flex items-center justify-between w-full py-5 px-8 text-left rounded-t-xl bg-color-4 text-white font-bold font-mont text-2xl", !open && "rounded-b-xl")}
          onClick={handleClick}
        >
